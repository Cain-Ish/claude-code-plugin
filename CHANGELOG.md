...
- Surface budget RATCHETED DOWN: scripts 52→51, tests 157→155. Executed by two Opus subagents (state/GC + tests/gate) with integrator verification; one earlier attempt died pre-write on a session cap and was cleanly re-run.
