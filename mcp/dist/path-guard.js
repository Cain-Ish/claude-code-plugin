...
export function assertWithin(baseDir, ...parts) {
    ...
    if (candidateResolved !== baseResolved && !candidateResolved.startsWith(baseResolved + sep)) {
        throw new PathGuardError(`path escapes base directory: ${candidateResolved} not within ${baseResolved}`, baseDir, parts.join('/'));
    }
