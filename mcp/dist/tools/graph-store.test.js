...
import { cmpTime, dateOf, loadEdges, foldToCurrent, validAt, neighbors, appendEdge, } from './graph-store.js';
async function tmpLog(lines) {
...
describe('validAt — half-open [valid_from, valid_to)', () => {
    const e = { from: 'wg-tunnel', to: 'pi-ip-ufw-sync', type: 'requires',
...
// --- A5: neighbors ----------------------------------------------------------
const G = [
    { from: 'a', to: 'b', type: 'requires', valid_from: '2026-05-01', valid_to: null },
    { from: 'b', to: 'c', type: 'requires', valid_from: '2026-05-01', valid_to: null },
    { from: 'a', to: 'd', type: 'affects', valid_from: '2026-05-01', valid_to: null },
    { from: 'x', to: 'a', type: 'affects', valid_from: '2026-05-01', valid_to: null },
    { from: 'a', to: 'old', type: 'requires', valid_from: '2026-05-01', valid_to: '2026-05-10' },
];
describe('neighbors', () => {
    ...
    it('depth 2 reaches c at a lower score than b', () => {
        ...
        const b = r.find(e => e.to === 'b');
        const c = r.find(e => e.to === 'c');
        expect(c).toBeTruthy();
...
describe('appendEdge', () => {
    ...
    it('rejects an invalid edge type', async () => {
        ...
        const p = join(dir, 'edges.jsonl');
        await expect(appendEdge(p, { op: 'assert', from: 'a', to: 'b', type: 'bogus', recorded_at: '2026-05-21T00:00:00Z' }))
            .rejects.toThrow(/invalid edge/i);
    });
});
//# sourceMappingURL=graph-store.test.js.map