...
export function assertSafeSlug(slug: string): void {
  ...
  // charset stays looser on purpose — see path-guard.test.ts for the accepted forms). Lives here
  // (not doc-sources.ts) so hash/slug-only importers don't drag doc-sources' glob tree into bundles.
